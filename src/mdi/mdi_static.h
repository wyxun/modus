...
typedef int32_t mdi_status_t;

#define MDI_STATUS_OK        ((mdi_status_t)0)
#define MDI_STATUS_EINVAL    ((mdi_status_t)-1)
#define MDI_STATUS_ENODEV    ((mdi_status_t)-2)
#define MDI_STATUS_EBUSY     ((mdi_status_t)-3)
#define MDI_STATUS_ETIMEOUT  ((mdi_status_t)-4)
#define MDI_STATUS_EIO       ((mdi_status_t)-5)
#define MDI_STATUS_ENOTSUP   ((mdi_status_t)-6)
#define MDI_STATUS_EAGAIN    ((mdi_status_t)-7)
